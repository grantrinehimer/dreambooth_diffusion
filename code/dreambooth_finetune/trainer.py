"""High‑level training wrapper – simplified but faithful to the original logic."""
import argparse
import copy
import gc
import importlib
...
from .datasets import DreamBoothDataset, PromptDataset, collate_fn
from .utils import encode_prompt, tokenize_prompt, model_has_vae, import_model_class_from_model_name_or_path
from .validate import log_validation, save_model_card
